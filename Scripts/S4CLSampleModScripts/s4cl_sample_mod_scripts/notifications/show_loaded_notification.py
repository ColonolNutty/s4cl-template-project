...
class S4CLSampleModShowLoadedMessage:
    ...
    @staticmethod
    def show_loaded_notification():
        """ Show that the sample mod has loaded. """
        notification = CommonBasicNotification(S4CLSampleModStringId.SAMPLE_MOD_LOADED_NOTIFICATION_TITLE, S4CLSampleModStringId.SAMPLE_MOD_LOADED_NOTIFICATION_DESCRIPTION)
        notification.show()
